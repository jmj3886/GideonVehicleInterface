 ...
 * @author Joshua
 */
public class HomeMenu_RPI extends javax.swing.JFrame {
    ...
    public HomeMenu_RPI() { 
       ...
       movies = GetMovies("/media/pi/VIDEO(1)");  
       InitMovies();
    ...
    private void initComponents() {
        ...
        movie1.setFont(new java.awt.Font("Garamond", 0, 11)); // NOI18N
        movie1.setText("Happy Gilmore");
        jPanel1.add(movie1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 50, 268, 44));

        movie2.setFont(new java.awt.Font("Garamond", 0, 11)); // NOI18N
        movie2.setText("Frankenstien");
        jPanel1.add(movie2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 100, 268, 44));

        movie3.setFont(new java.awt.Font("Garamond", 0, 11)); // NOI18N
        movie3.setText("Supernatural - S01E12 - BLAH BLAH");
        jPanel1.add(movie3, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 150, 268, 44));

        movie4.setFont(new java.awt.Font("Garamond", 0, 11)); // NOI18N
        movie4.setText("House - S02E02 - BLAH BLAH");
        jPanel1.add(movie4, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 200, 268, 44));

        movieUp.setFont(new java.awt.Font("Garamond", 0, 11)); // NOI18N
        movieUp.setText("Move Down");
        jPanel1.add(movieUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 260, 131, 33));

        movieDown.setFont(new java.awt.Font("Garamond", 0, 11)); // NOI18N
        movieDown.setText("Move Up");
        jPanel1.add(movieDown, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 260, 119, 33));
        ...
        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 480, 280));
        ...
        displaySingle1.setLcdMaxValue(1000000.0);
        displaySingle1.setLcdUnitString("miles");
        displaySingle1.setLcdValue(93000.0);
        ...
        jPanel2.add(displaySingle1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 50, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeMenu_RPI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeMenu_RPI().setVisible(true);
            }
        });
    }
